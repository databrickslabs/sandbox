...
# MAGIC %md
# MAGIC # Function Test: DLT Serverless Compute
# MAGIC
# MAGIC **Objective:** Validate `calculate_line_item_costs()` function for DLT Serverless workloads
# MAGIC
...
if len(results) > 0:
    ...
    display_cols = [
        'scenario', 'cloud', 'region', 'tier', 'dlt_edition', 'serverless_mode', 'instance_type', 'num_workers',
    ...
    print("Note: Shows DLT edition + serverless mode. Instance types derive DBU, VM costs = $0")
    print("=" * 200)
    ...
    print("=" * 200)
    print("DLT SERVERLESS COST CALCULATION:")
    print("  DBU Cost = (Base DBU × DLT Edition × Photon × Mode) × Hours/Month × DBU Price")
    print("  VM Cost  = $0 (serverless)")
    print("  Total    = DBU Cost")
    print("=" * 200)
