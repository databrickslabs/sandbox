...
# MAGIC %md
# MAGIC # Test_Func_08: DBSQL Pro Cost Calculation
# MAGIC 
# MAGIC **Objective:** Validate `calculate_line_item_costs()` function for DBSQL Pro workloads
# MAGIC 
...
for scenario in test_scenarios:
    ...
    FROM lakemeter.calculate_line_item_costs(
        ...
        'PRO'::VARCHAR,                         -- dbsql_warehouse_type
