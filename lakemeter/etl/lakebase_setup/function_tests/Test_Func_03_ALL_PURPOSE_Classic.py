...
# MAGIC %md
# MAGIC # Function Test: ALL_PURPOSE Classic Compute
# MAGIC
# MAGIC **Objective:** Validate `calculate_line_item_costs()` function for ALL_PURPOSE Classic workloads
# MAGIC
...
if len(results) > 0:
    ...
    results_df['total_worker_dbu_hr'] = results_df['worker_dbu_hr_each'] * results_df['num_workers']
    ...
    print("Note: Shows driver + worker breakdown for VM and DBU costs")
    print("=" * 200)
    ...
    print("=" * 200)
    print("CLASSIC COMPUTE COST CALCULATION:")
    print("  DBU Cost = (Driver DBU + Worker DBU) × Hours/Month × DBU Price")
