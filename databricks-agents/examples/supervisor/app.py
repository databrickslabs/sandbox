...
@app.tool(description="Route query to appropriate sub-agent (research, expert_finder, analytics, compliance)")
async def route_query(messages: List[dict]) -> dict:
    ...
    try:
        ...
        # Handle both List[dict] and plain string (MCP fallback sends string)
        ...
        # Extract response text from OutputItem (content-based or text-based)
        response_text = ""
        if response.output:
        ...
        # Include routing metadata for lineage tracking
...
if __name__ == "__main__":
    ...
    print("\n🤖 Sub-agents:")
    print("   - research           → Expert transcript research")
